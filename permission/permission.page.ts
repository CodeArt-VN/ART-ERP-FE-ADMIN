...
import { BRA_BranchProvider, SYS_AccountGroupProvider, SYS_FormProvider, SYS_PermissionListProvider } from 'src/app/services/static/services.service';
...
export class PermissionPage extends PageBase {
	...
	selectBranch() {
		...
		this.env.showLoading('Please wait for a few moments', this.pageProvider.read(this.query)).then((resp: any) => {
