...
import { AC_CaseProvider, BI_HRM_PayrollPerBranchProvider, CRM_ContactProvider, FINANCE_TaxDefinitionProvider, HRM_StaffProvider, SYS_ConfigOptionProvider, SYS_ConfigProvider, WMS_AllocationStrategyProvider, WMS_LocationProvider, WMS_PriceListProvider, WMS_PutawayStrategyProvider, WMS_ZoneProvider } from 'src/app/services/static/services.service';
    ...
    .then(async (result:any) => {
      if(result?.data?.length>0){
        ...
        this.columns = [...new Map(
          this.configOptions
              .map((i) => [i['Code'], { Code: i.Code, Name: i.Name, DataType: i.DataType, Sort: i.Sort }])
